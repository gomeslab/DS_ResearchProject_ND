%% Hexagon 
% This file will create training data that includes deltaR, deltaI, and a
% scale factor as well as either spec points or peak information 


fn1 = '/Users/emory/Documents/GitHub/DS_ResearchProject_ND/2016-08-01 Hexaxgonal Corral/';
% This is the geometry of the hexagon 
cd(fn1)
%% Experimental Data 
dv5 = 5*10^-3;
mpp = 0.1;
...
csvwrite('/Users/emory/Documents/GitHub/DS_ResearchProject_ND/HexagonExperimentalData180721_PS_sf.csv', expSpec2');
...
trainingB = zeros(training_size, (3+4*np));
...
for i = 1:training_size
    ...
    trainingB(i,:) = [deltaI deltaR scale_factor testA(:,2)', testA(:,3)', testA(:,4)', testA(:,5)'];
...
csvwrite('/Users/emory/Documents/GitHub/DS_ResearchProject_ND/Training_Data/Hexagon/HexagonExperimentalData180721_PS_sf_specPoints.csv', expSpec2);
csvwrite('/Users/emory/Documents/GitHub/DS_ResearchProject_ND/Training_Data/Hexagon/HexagonExperimentalData180721_PS_sf_peakinfo.csv', expSpec5);
